    ...
    <b-container>
      <b-row class="mb-5">
        <b-col md="12">
          ...
          >
            <p class="mb-0">
              Returning shipping_address? <router-link :to="{name: 'login'}">
                Click here
                    ...
                    <b-tbody>
                      ...
                      <b-tr>
                        ...
                        <b-td class="text-black">
                          {{ subtotal | currency(currency_format) }}
                        </b-td>
                      </b-tr>
                      <b-tr>
                        <b-td class="text-black font-weight-bold">
...
export default {
  ...
  created() {
    this.$store.dispatch(`${COUNTRY}${FETCH_ITEMS_LIST}`);
  },
