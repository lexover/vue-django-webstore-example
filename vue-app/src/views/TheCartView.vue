            ...
            <table class="table">
              ...
              <tbody>
                ...
                >
                  ...
                  <td
                    v-if="item.product.sale_price > 0"
                    class="align-middle"
                  >
                  ...
                  <td
                    ...
                    class="align-middle"
                  >
                    {{ item.product.price | currency(currency_format) }}
                  </td>
          ...
          <b-row class="justify-content-end">
            <b-col md="7">
              <b-row>
                <b-col
                  md="12"
                  class="text-right border-bottom mb-5"
                >
...
export default {
  ...
  methods: {
    ...
    changeQuantity(quanitity, item) {
      const value = { ...item, quantity: quanitity };
